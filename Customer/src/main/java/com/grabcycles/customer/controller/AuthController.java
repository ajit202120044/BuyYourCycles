...
public class AuthController {
    ...
    public String login() {
        LoggService.logger.info("logging created  for customer login page ");
      return "login";
    }

    @GetMapping("/register")
    public String register(Model model) {
        LoggService.logger.info("logging created  for customer register page ");
    ...
    public String processRegister(@Valid @ModelAttribute("customerDto") CustomerDto customerDto,
        ...
        LoggService.logger.info("logging created  for customer do- register page ");
        try {
            if (result.hasErrors()) {
